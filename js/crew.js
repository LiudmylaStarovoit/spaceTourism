...
commander.addEventListener('click', () => {
    ...
    image.src = "./image/crew/image-douglas-hurley.png";
...
specialist.addEventListener('click', () => {
    ...
    image.src = "./image/crew/image-mark-shuttleworth.png";
    if (window.matchMedia("(min-width: 577px)").matches) {
...
pilot.addEventListener('click', () => {
    ...
    image.src = "./image/crew/image-victor-glover.png";
    if (window.matchMedia("(min-width: 577px)").matches) {
...
engineer.addEventListener('click', () => {
    ...
    image.src = "./image/crew/image-anousheh-ansari.png";
    if (window.matchMedia("(min-width: 577px)").matches) {
